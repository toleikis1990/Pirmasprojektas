...
/*        boolean isThereANameWhichLenghtIsGtThan3 = false;
        for (int i = 0; i< names.size(); i++){
            if (names.get(i).length()>3){
                isThereANameWhichLenghtIsGtThan3 = true;
                break;
            }
        }*/
        boolean isThereANameWhichLenghtIsGtThan3 = names.stream().anyMatch(name -> name.length() > 3);
        System.out.println("Ar yra bent vienas vardas kurio ilgis yra > 3: " + isThereANameWhichLenghtIsGtThan3);
